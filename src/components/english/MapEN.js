        ...
        <Grid container className="map-wrapper" direction="column">
          ...
          <Grid xs={12} className="map-description-wrapper-mobile color-1">
            ...
            <p className="color-1 description-text-mobile">
                ...
                <b style={{color: 'red'}}> Student union building and basement (Ylioppilastalo) </b> <br />
        ...
        <Grid container className="bus-timetable-wrapper color-1" direction="row" >
          <Grid xs={12} className="bus-timetable-wrapper">
            ...
            <p className="color-1 description-text-mobile">
              ...
              A non-stop shuttle bus for Integraatiofest participants runs from Saturday night to Sunday morning between 03:00 - 04:00 from LUT University to the City Center (accommodation). <pre />
        ...
        <Grid container className="bus-timetable-wrapper color-1" direction="row" >
          ...
          <Grid md={6} className="bus-timetable-search-wrapper">
            <Typography variant='h5' className="map-title" sx={{textAlign: "center"}}> Route LUT University - Lyseo (City Center) </Typography>
              <Iframe 
                url="https://lappeenranta.digitransit.fi/haku?&lang=en&address1=Lappeenrannan teknillinen yliopisto, (LUT), Yliopistonkatu 34, Lappeenranta&lon1=28.09156&lat1=61.064525&address2=Lyseo I, Lappeenranta&lon2=28.180633&lat2=61.057604"
                width="96%"
                height="250px"
                className="bus-timetable"
                display="block"
              ...
              <Iframe 
                url="https://lappeenranta.digitransit.fi/haku?&lang=en&address1=Lyseo L, Lappeenranta&lon1=28.180236&lat1=61.057718&address2=Lappeenrannan teknillinen yliopisto, (LUT), Yliopistonkatu 34, Lappeenranta&lon2=28.09156&lat2=61.064525" 
                width="96%"
                height="250px"
                className="bus-timetable"
                display="block"
