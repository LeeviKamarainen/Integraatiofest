  ...
  return (
    <>
        ...
        <p className="timetable-text">
            ...
            <span className="timetable-item"> <b>12:00 - 14:00 <span className="location">Yliopiston aula:</span> Posterisessio ja haalarimerkkitori<br /> </b> </span> 
            ...
            <span className="timetable-item">15:00 - 17:00 Aikaa käydä majoituksessa <br /></span>
