...
function LeftNavBar() {
    return (
      <Navbar className="bottomnav" expand="lg" fixed="left" bg="none" variant="dark" style={{ width: '10%', left:'0%', top:"10%", height:"100vh", borderRadius: '10px', flexDirection:"column",alignItems:"flex-start",justifyContent:"flex-start"}}>
